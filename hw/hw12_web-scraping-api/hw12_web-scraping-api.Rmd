...
```{r scrape-wiki-table, include = TRUE}
...
```{r clean-wiki-table, include = TRUE}
countriesRnD <-
	wikiRnDTable %>%
...
```{r explore-rnd-total, results = "asis"}
...
```{r explore-rnd-percent, results = "asis"}
...
```{r nobel-prize-get-countries, results = "asis"}
...
```{r map-country-codes, results = "asis"}
countryMap <-
...
```{r merge-country-codes, results = "asis"}
...
```{r get-laureates-api, cache = TRUE}
...
```{r clean-laureates-per-country, results = "asis"}
laureatesPerCountry %<>%
	data.frame() %>%
...
```{r merge-rnd-laureates, results = "asis"}
...
```{r scrape-population, results = "asis"}
...
```{r clean-pop-table, results = "asis"}
countryPop %<>% 
